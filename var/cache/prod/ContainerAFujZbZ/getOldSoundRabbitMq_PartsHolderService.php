...
$a = ($this->services['old_sound_rabbit_mq.component_create_consumer'] ?? $this->load('getOldSoundRabbitMq_ComponentCreateConsumerService.php'));

$instance->addPart('old_sound_rabbit_mq.base_amqp', $a);
$instance->addPart('old_sound_rabbit_mq.consumer', $a);
