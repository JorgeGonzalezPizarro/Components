...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Command\\ExampleCommand' => function (): \App\Command\ExampleCommand {
    return ($this->privates['App\Command\ExampleCommand'] ?? $this->load('getExampleCommandService.php'));
...
}, 'console.command.messenger_consume_messages' => function (): \Symfony\Component\Messenger\Command\ConsumeMessagesCommand {
    return ($this->privates['console.command.messenger_consume_messages'] ?? $this->load('getConsole_Command_MessengerConsumeMessagesService.php'));
}, 'console.command.messenger_debug' => function (): \Symfony\Component\Messenger\Command\DebugCommand {
    return ($this->privates['console.command.messenger_debug'] ?? $this->load('getConsole_Command_MessengerDebugService.php'));
