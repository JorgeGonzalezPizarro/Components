...
$a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Domain\\Components\\Domain\\Component\\Components') => 'App\\Domain\\Components\\Domain\\Component\\Components', ($this->targetDirs[3].'\\src\\Domain\\Components\\Domain\\Component') => 'App\\Domain\\Components\\Domain\\Component', ($this->targetDirs[3].'\\src\\Domain\\Components\\Domain\\Component\\Components\\ComponentsVO') => 'App\\Domain\\Components\\Domain\\Component\\Components\\ComponentsVO'));
$a->setGlobalBasename('mapping');

$b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$b->addDriver($a, 'App\\Domain\\Components\\Domain\\Component\\Components');
$b->addDriver($a, 'App\\Domain\\Components\\Domain\\Component');
$b->addDriver($a, 'App\\Domain\\Components\\Domain\\Component\\Components\\ComponentsVO');

$c = new \Doctrine\ORM\Configuration();
$c->setEntityNamespaces(array('Components' => 'App\\Domain\\Components\\Domain\\Component\\Components', 'Component' => 'App\\Domain\\Components\\Domain\\Component', 'Embebed' => 'App\\Domain\\Components\\Domain\\Component\\Components\\ComponentsVO'));
...
$c->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('components_repository_doctrine' => function () {
    return ($this->privates['components_repository_doctrine'] ?? $this->load('getComponentsRepositoryDoctrineService.php'));
}))));
